...
export default function PIPlanPage() {
  ...
  const tabs: PageTab[] = [
    { id: "pi-plan", label: "PI Planning Board" },
    { id: "objectives", label: "PI Objectives" },
    { id: "dependencies", label: "Team Dependencies" },
  ];
  ...
  return (
    ...
    >
      <DashboardHeader
        title="PI Planning"
        description="Plan and track Program Increments"
      >
